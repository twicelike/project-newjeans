  ...
  const bioSelectedTags = document.getElementById('setupSelectedTags');
  ...
  function createTag(selectedButton, emoji, text, section) {
      ...
      button.addEventListener('click', function () {
        tag.remove();
        removeInterest(text, section, null,bioselectedInterests);
...
function removeInterest(interest, section, button, listInterest) {
  ...
  document.querySelectorAll('#addHobbies .interest-btn').forEach(button => {
